...
public class Framework extends Canvas {
     ...
     */
    public static enum GameState{STARTING, VISUALIZING,LOADING, MAIN_MENU, OPTIONS, PLAYING, GAMEOVER, DESTROYED}
    /**
   ...
   /**
    ...
    {
    	try { 
			background = ImageIO.read(Game.class.getClassLoader()
    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            ...
            case LOADING:
            	 g2d.drawImage(background,0,0,  frameWidth,frameHeight,null);
            	  g2d.setFont(new Font("TimesNewRoman",Font.PLAIN,50));
            	g2d.drawString(String.valueOf(Game.loaded)+ " /19 loaded", frameWidth /2,frameHeight/2);
            break;
            case STARTING:
            	  g2d.setFont(new Font("TimesNewRoman",Font.PLAIN,50));
              	g2d.drawString(String.valueOf(Game.loaded)+ " /1 loaded", frameWidth /2,frameHeight/2);
    ...
    private void newGame()
    {
        ...
        game = new Game(frameHeight,frameWidth);
    ...
    @Override
    public void keyTypedFramework(KeyEvent e) {
